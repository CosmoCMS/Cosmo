...
angular.module('angular-growl').directive('growl', [
  ...
  function ($rootScope) {
    ...
    return {
      restrict: 'A',
      template: '<div class="growl">' + '\t<div ng-repeat="message in messages" ng-class="{{classes}}">' + '\t\t<button type="button" class="close" ng-click="deleteMessage(message)">&times;</button>' + '       <div ng-switch="message.enableHtml">' + '           <div ng-switch-when="true" ng-bind-html="message.text"></div>' + '           <div ng-switch-default ng-bind="message.text"></div>' + '       </div>' + '\t</div>' + '</div>',
      replace: false,
      scope: true,
      controller: [
        '$scope',
